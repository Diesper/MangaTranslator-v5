...
describe('background/actions/deliver-result-from-tab.js', () => {
    ...
    test('usa o mapeamento temporário, remove a aba e entrega o resultado', async () => {
        ...
        }) }), { action: 'IMAGE_READY_FROM_NEW_TAB', src: 'data:image/png;base64,AA' }, { tab: { id: 82, url: 'https://cdn.example/result.png' } });
    ...
    test('rejeita lote obsoleto sem entregar a imagem', async () => {
        ...
        }) }), { action: 'IMAGE_READY_FROM_NEW_TAB', src: 'data:image/png;base64,AA' }, { tab: { id: 83, url: 'https://cdn.example/result.png' } });
